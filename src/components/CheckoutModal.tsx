    ...
    return (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 sm:p-6">
            ...
            <div className="relative w-full max-w-lg overflow-hidden rounded-[2.5rem] border border-white/10 bg-[#0a0a0a] shadow-2xl transition-all">
                ...
                <div className="absolute -bottom-24 -right-24 h-48 w-48 rounded-full bg-pink-600/20 blur-[80px]" />
                ...
                <div className="relative p-8">
                    ...
                    {state === "info" && (
                        <div className="mt-4">
                            ...
                            <p className="text-zinc-400 mb-8">Secure your digital excellence.</p>

                            <div className="rounded-2xl bg-white/5 p-6 mb-8 border border-white/5">
                                <div className="flex justify-between items-center">
                                    <div>
                                        <h4 className="text-sm font-medium text-zinc-500 uppercase tracking-wider mb-1">Product</h4>
                    ...
                    {state === "processing" && (
                        <div className="flex flex-col items-center justify-center py-16 text-center">
                            <div className="relative mb-8">
                                ...
                                <Loader2 className="h-16 w-16 text-purple-500 animate-spin relative" />
                            </div>
                    ...
                    {state === "success" && (
                        <div className="mt-4 text-center">
                            ...
                            <p className="text-zinc-400 mb-8">Payment was successful. Your download has started automatically.</p>

                            <div className="rounded-2xl bg-green-500/5 p-6 mb-8 border border-green-500/10 flex items-center gap-4 text-left">
                                <Download className="h-8 w-8 text-green-500" />
                                <div>
                                    <p className="text-sm font-bold text-white">{selectedProduct.name}.pdf</p>
                                    <p className="text-xs text-zinc-500 text-uppercase tracking-widest font-bold">Ready for use</p>
                                </div>
                            </div>
